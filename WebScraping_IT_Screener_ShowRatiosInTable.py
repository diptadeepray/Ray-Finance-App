...
def WebScrapingTCS():
    # Send the request
    response = requests.get("https://www.screener.in/company/TCS/consolidated/", headers=headers)
    # Parse the HTML
...
def WebScrapingOtherITCompanies(url):
    # Send the request
...
for oneITComapnyLink in allOtherITCompanyinks:
    WebScrapingOtherITCompanies(oneITComapnyLink)
print()
print(summary_points)
